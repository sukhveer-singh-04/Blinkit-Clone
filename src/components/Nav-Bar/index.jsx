            ...
            <div className="navbar">
                <div className="nav-left">
                    ...
                    <div className="address">
                        <h3 className="delivery">Delivery in 10 minutes</h3>
                        <p className="location">SAS Nagar, Mohali, Punjab</p>
                    </div>
                </div>
                <div className="search">
                    <div className="search-icon">
                        <img src='images/magnifying-glass-solid.svg' alt="search-icon"></img>
                    </div>
                ...
                <div className="nav-right">
                    ...
                    <button className="cart">
                        <div className="cart-icon">
                            <img src='images/cart-plus-solid.svg' alt="cart-icon"></img>
                        </div>Cart</button>
                </div>
            </div>
